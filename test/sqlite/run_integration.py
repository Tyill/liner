...
"""
Run SQLite-backed integration scripts under ``test/sqlite/``.

Usage:
  python3 test/sqlite/run_integration.py
  python3 test/sqlite/run_integration.py --list
  python3 test/sqlite/run_integration.py --only burst,offline
  python3 test/sqlite/run_integration.py --continue-on-fail

Cooperating processes share one temporary ``*.sqlite`` file per script (no Redis).
"""
