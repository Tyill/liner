...
fn  main() {
    ...
    liner_broker::ln_subscribe(&mut hclient1, topic_for_subscr.as_ptr());
    liner_broker::ln_subscribe(&mut hclient2, topic_for_subscr.as_ptr());
    liner_broker::ln_subscribe(&mut hclient3, topic_for_subscr.as_ptr());
